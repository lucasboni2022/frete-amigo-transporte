...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FreteBR — Plataforma de fretes do Brasil" },
      { name: "description", content: "Conecte cargas e caminhoneiros em todo o Brasil. Publique cargas, encontre fretes e negocie diretamente." },
      { property: "og:title", content: "FreteBR — Plataforma de fretes" },
      { property: "og:description", content: "Encontre fretes e cargas em todo o Brasil." },
